  ...
  options: [
    {
      ...
      description:
        'Search you want to perform, replace the url below with the search that users can run. The {{ENTITY}} is the information that will get passed into the search. Name> is the name of the search that will be occuring, please ensure the name of the search ends with ">"',
